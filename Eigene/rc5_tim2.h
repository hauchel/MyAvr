...
/*
  ...
  const unsigned int short_time = 1400;                   // Used as a minimum time for short pulse or short space ( ==>  700 us)
  const unsigned int  med_time = 2400;                    // Used as a maximum time for short pulse or short space ( ==> 1200 us)
  const unsigned int  long_time = 4000;                     // Used as a maximum time for long pulse or long space   ( ==> 2000 us)
  const byte tcrb = 2;

  // Define number of Timer1 ticks (with a prescaler of 1/64)
  const unsigned int short_time = 175;                   // Used as a minimum time for short pulse or short space ( ==>  700 us)
  const unsigned int  med_time = 300;                    // Used as a maximum time for short pulse or short space ( ==> 1200 us)
  const unsigned int  long_time = 500;                     // Used as a maximum time for long pulse or long space   ( ==> 2000 us)
  const byte tcrb = 3;

  // Define number of Timer1 ticks (with a prescaler of 1/256)
...
boolean rc5_ok = 0, rc5_toggle_bit;
byte rc5_state = 0, rc5_hh, rc5_address, rc5_command;
